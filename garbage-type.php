   ...
   <div class="wrapper">
      <nav class="main-header navbar navbar-expand navbar-light" style="background-color: rgb(86,181,42)">
         ...
         <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
               <a class="nav-link" data-widget="fullscreen" href="../mainindex.html" role="button">
      ...
      <div class="content-wrapper">
         ...
         <div class="container-fluid">
            <div class="row">
               ...
               // Query to fetch garbage types
               $sql = "SELECT * FROM garbage_types";
               ...
               if ($result->num_rows > 0) {
                   ...
                   while ($row = $result->fetch_assoc()) {
                       ...
                       <div class="col-6 col-sm-6 col-md-3">
                           <div class="info-box">
                               <span class="info-box-icon text-warning elevation-4"><img src="../asset/img/'.$row['icon'].'" width="50"></span>
                               <div class="info-box-content">
                                   <span class="info-box-text">
                                       <span class="float-sm-right"><a class="btn btn-sm" href="#" data-toggle="modal" data-target="#delete"><i class="fa fa-trash-alt text-danger"></i></a></span>
                                       <h5>'.$row['name'].'</h5>
                                   </span>
