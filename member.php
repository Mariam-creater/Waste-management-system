...
<body class="hold-transition sidebar-mini layout-fixed">
   <div class="wrapper">
      <nav class="main-header navbar navbar-expand navbar-light" style="background-color: rgb(86,181,42)">
         ...
         <li class="nav-item">
            <a href="../mainindex.html" class="nav-link" role="button" title="Login">
    ...
    while ($row = mysqli_fetch_assoc($query)) {
        ...
        <tr>
            ...
            <td>***********</td>
            <td>
                <a class="btn btn-sm btn-success" href="#" data-toggle="modal" data-target="#edit<?php echo $row['id']; ?>">Update</a>
                <a class="btn btn-sm btn-danger" href="#" data-toggle="modal" data-target="#delete<?php echo $row['id']; ?>">Delete</a>
            </td>
        </tr>
    <?php } ?>
    </tbody>
